function C_PostUpdateDialog()
{
    ...
    this.onPostSuccess = function(form, action)
    {
        ...
        this.setMessage("Ride Update Posted", "green");
    ...
    this.onPostFailure = function(form, action)
    {
        ...
        switch(action.failureType) {
            ...
            // --- failure message returned from code on the server
                this.setMessage("Error posting update: " + action.result.message, "red");
                break;
            case Ext.form.Action.CONNECT_FAILURE:
            // --- Failed to connect to server
                this.setMessage("Error posting update: Server did not respond", "red");
                break;
        }
    }
