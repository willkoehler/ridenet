...
<body style="margin:0px">
  ...
  <table cellspacing=0 cellpadding=0 style="margin:0px 0px 0px 35px;width:1210px">
    <tr>
      <td valign=top>
        <div style="width:790px">   <!-- Need this <div> to chop extra-long unbreakable lines in ride logs-->
          <!-- Ride Widget -->
      ...
      <td class="sidebar" style="width:420px" valign=top>
