...
<body style="margin:0px">
  ...
  <table cellspacing=0 cellpadding=0 style="margin:3px 0px 0px 39px;width:1202px">
    <tr>
      <td valign=top>
        <div style="width:787px">   <!-- Need this <div> to chop extra-long unbreakable lines in ride logs-->
          <!-- Ride Widget -->
      ...
      <td class="sidebar" style="width:415px" valign=top>
