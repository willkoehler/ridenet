...
<body style="margin:0px;">
  ...
  <table cellspacing=0 cellpadding=0 style="margin:0px 0px 0px 37px;width:1215px">
    <tr>
      <td valign=top>
        <div style="width:795px">   <!-- Need this <div> to chop extra-long unbreakable lines in ride logs-->
          <!-- Ride Widget -->
